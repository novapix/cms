 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Video wherePriority($value)
...
class Video extends Model
{
    ...
    protected $fillable = ['name', 'url', 'duration', 'resolution', 'description', 'priority', 'thumbnail_url'];
}
